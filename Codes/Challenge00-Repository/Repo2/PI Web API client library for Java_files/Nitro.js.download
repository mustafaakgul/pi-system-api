...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['./NitroJSConnector', './NitroCookies'], function(NitroJSConnector, NitroCookies) {
            return root.Nitro = factory(NitroJSConnector, NitroCookies);
        });
    } else {
        root.Nitro = factory(root.NitroJSConnector, root.NitroCookies);
    }
}(this, function(NitroJSConnector, NitroCookies) {
